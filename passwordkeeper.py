...
the password is 1234 (access="1234")

* before starting create a file passwords.txt in same diractory.
in linux if you hide the file make sure that you change the filename in the code.
in windows you can hide the file and it wont affect the code.
'''
...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        self.l = Label(top, text=" Password: ", font=('Verdana', 15), justify=CENTER)
        self.l.pack(pady=10)
        self.e = Entry(top, show='*',justify=CENTER, font=('Verdana', 12), width=20)
        self.e.pack(pady=7)
        self.b = Button(top, text='Submit', command=self.cleanup, font=('Verdana', 14), border=0)
        self.b.pack(pady=7)
...
class entity_display:
    ...
    def __init__(self, master, n, e, p, i):
        ...
        self.label_name = Label(self.window, text=dencryptedN, font=('Verdana', 14))
        self.label_email = Label(self.window, text=dencryptedE, font=('Verdana', 14))
        self.label_pass = Label(self.window, text=dencryptedP, font=('Verdana', 14))
...
entity_label = Label(window, text='Add Entity', font=('Verdana', 18))
name_label = Label(window, text='Name: ', font=('Verdana', 14))
email_label = Label(window, text='Email: ', font=('Verdana', 14))
pass_label = Label(window, text='Password: ', font=('Verdana', 14))
name = Entry(window, font=('Verdana', 14))
email = Entry(window, font=('Verdana', 14))
password = Entry(window, show='*', font=('Verdana', 14))
submit = Button(window, text='Add Information', command=onsubmit, font=('Verdana', 14))
...
name_label2 = Label(window, text='Name: ', font=('Verdana', 14))
email_label2 = Label(window, text='Email: ', font=('Verdana', 14))
pass_label2 = Label(window, text='Password: ', font=('Verdana', 14))
